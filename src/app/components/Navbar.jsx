  ...
  return (
    <nav className="bg-fifth p-4 flex justify-between items-center shadow-sm">
      ...
      <div className="flex items-center justify-center">
        <img
          src="https://img.freepik.com/free-vector/abstract-logo-triangular-shape_1043-1.jpg?t=st=1715395100~exp=1715398700~hmac=54d70a72941fc169987438815651d4310a21bd800a566ec96459ac7fa7911680&w=826"
          alt="Logo"
